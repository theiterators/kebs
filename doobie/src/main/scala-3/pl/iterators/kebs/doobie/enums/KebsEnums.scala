...
trait KebsEnums {
  ...
  inline given enumArrayMeta[E](using e: EnumLike[E], m: Meta[Array[String]], ct: ClassTag[E]): Meta[Array[E]] =
    m.imap(_.map(e.valueOf))(_.map(_.toString))
  inline given enumOptionArrayMeta[E](using
      e: EnumLike[E],
  ...
  trait Uppercase {
    inline given enumUppercaseMeta[E](using e: EnumLike[E]): Meta[E] = Meta.StringMeta.imap(s =>
    ...
    inline given enumUppercaseArrayMeta[E](using e: EnumLike[E], m: Meta[Array[String]], ct: ClassTag[E]): Meta[Array[E]] = m.imap(
    ...
    inline given enumUppercaseOptionArrayMeta[E](using
        e: EnumLike[E],
        m: Meta[Array[Option[String]]],
        ct: ClassTag[Option[E]]
  ...
  trait Lowercase {
    inline given enumLowercaseMeta[E](using e: EnumLike[E]): Meta[E] = Meta.StringMeta.imap(s =>
      e.values.find(_.toString.toLowerCase == s).getOrElse(throw new IllegalArgumentException(s"enum case not found: $s"))
    )(_.toString.toLowerCase)
    inline given enumLowercaseMeta[E](using e: EnumLike[E], m: Meta[Array[String]], ct: ClassTag[E]): Meta[Array[E]] = m.imap(
    ...
    inline given enumLowercaseOptionArrayMeta[E](using
        e: EnumLike[E],
        m: Meta[Array[Option[String]]],
        ct: ClassTag[Option[E]]
    ): Meta[Array[Option[E]]] = m.imap(
