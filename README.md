...
`libraryDependencies += "pl.iterators" %% "kebs-slick" % "1.8.0"`

Support for `spray-json`

`libraryDependencies += "pl.iterators" %% "kebs-spray-json" % "1.8.0"`

Support for `play-json`

`libraryDependencies += "pl.iterators" %% "kebs-play-json" % "1.8.0"`

Support for `akka-http`

`libraryDependencies += "pl.iterators" %% "kebs-akka-http" % "1.8.0"`

Support for `tagged types`

`libraryDependencies += "pl.iterators" %% "kebs-tagged" % "1.8.0"`

or for tagged-types code generation support

`libraryDependencies += "pl.iterators" %% "kebs-tagged-meta" % "1.8.0"`
