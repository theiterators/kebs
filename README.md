...
`libraryDependencies += "pl.iterators" %% "kebs-slick" % "1.5.2"`

Support for `spray-json`

`libraryDependencies += "pl.iterators" %% "kebs-spray-json" % "1.5.2"`

Support for `play-json`

`libraryDependencies += "pl.iterators" %% "kebs-play-json" % "1.5.2"`

Support for `akka-http`

`libraryDependencies += "pl.iterators" %% "kebs-akka-http" % "1.5.2"`

Support for `avro4s`

`libraryDependencies += "pl.iterators" %% "kebs-avro" % "1.5.2"`
