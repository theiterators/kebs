...
class ValueEnumOf[V, E <: { def value: V }](val `enum`: ValueEnumLike[V, E])

object ValueEnumOf {
  inline given [V, E <: { def value: V } with Enum](using m: Mirror.SumOf[E], ct: ClassTag[E]): ValueEnumOf[V, E] = {
